...
from ..data.market_repository import DatabasePriceDataRepository, PriceDataRepository, TimeRange
...
def run_analysis_for_symbols(
    ...
    cfg = get_config()
    repo: PriceDataRepository = DatabasePriceDataRepository(db_path=db_path)
