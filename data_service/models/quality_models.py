...
class BatchDownloadResult:
    ...
    def get_summary(self) -> str:
        """获取结果摘要"""
        return f"批量下载完成: {self.successful}/{self.total} 成功，耗时 {self.total_duration:.2f}秒"


# 工具函数
def create_empty_data_quality(symbol: str, issues: List[str] = None) -> DataQuality:
    """创建空的数据质量评估"""
    return DataQuality(
...
def assess_overall_quality(stock_available: bool, financial_available: bool, 
                          stock_completeness: float = 0.0, 
                          financial_completeness: float = 0.0) -> str:
    """
    评估整体数据质量等级
...
def create_download_result(success: bool, symbol: str, data_type: str, 
                          data_points: int = 0, error_message: str = None, **kwargs) -> DownloadResult:
    """创建下载结果的便捷函数"""
